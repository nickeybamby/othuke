  ...
  return (
    ...
    >
      <h1 className=" flex flex-col text-4xl xl:text-[84px] sm:text-5xl md:text-6xl font-semibold xl:leading-[95px] max-w-5xl gap-3">
        ...
        <span className="">Begin yours here.</span>
      </h1>

      <p className="text-sm smtext-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3">
